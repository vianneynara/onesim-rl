...
```shell
# Thomas Clustering, Randomized Seed (pid: best-ql-c-ms@0 and best-lfe-c-ms@0), config: 30,35,11,1,36
...
# Thomas Clustering, Fixed Seed (pid: best-ql-c-ms@1 and best-lfe-c-ms@1), config: 35,15,23,2,36
...
# Homogenous Poisson, Randomized Seed (pid: best-ql-p-ms@0 and best-lfe-p-ms@0), config: 27,14,35,1,36
...
# Homogenous Poisson, Fixed Seed (pid: best-ql-p-ms@1 and best-lfe-p-ms@1), config: 12,35,27,1,36
