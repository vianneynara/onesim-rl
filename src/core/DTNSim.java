...
public class DTNSim {
	...
	/**
	 * If this option ({@value}) is given to program, the settings will assume the next
	 * argument is an overriding line of settings.
	 */
	public static final String SETTING_DEF_FLAG = "-d";
	/**
	 * Separator for setting overrides in command line.
	 */
