 ...
 * @author Jordan, Nara
 */
public class StationaryClusteredOLD extends StationaryNodes {
	/**
	 * Number of clusters
	 */
	...
	public StationaryClusteredOLD(Settings s) {
		super(s);
	...
	public StationaryClusteredOLD(StationaryClusteredOLD sc) {
		super(sc);
	...
	@Override
	public StationaryClusteredOLD replicate() {
		return new StationaryClusteredOLD(this);
	}
